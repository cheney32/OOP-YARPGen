...
GenPolicy::GenPolicy() {
    ...
    var_kind_distr.emplace_back(Probability<VarKindID>(VarKindID::STRUCT_MBR, 0));
    var_kind_distr.emplace_back(Probability<VarKindID>(VarKindID::CLASS_MBR, 0));
    var_kind_distr.emplace_back(Probability<VarKindID>(VarKindID::CLASS_PRIVATE_MBR, 0));
    var_kind_distr.emplace_back(Probability<VarKindID>(VarKindID::DYN_STRUCT_MBR, 0));
    var_kind_distr.emplace_back(Probability<VarKindID>(VarKindID::DYN_CLASS_MBR, 0));
    ...
    arr_kind_distr.emplace_back(Probability<ArrKindID>(ArrKindID::STRUCT_MBR, 0));
    arr_kind_distr.emplace_back(Probability<ArrKindID>(ArrKindID::CLASS_MBR, 0));
    arr_kind_distr.emplace_back(Probability<ArrKindID>(ArrKindID::DYN_STRUCT_MBR, 0));
    arr_kind_distr.emplace_back(Probability<ArrKindID>(ArrKindID::DYN_CLASS_MBR, 0));
